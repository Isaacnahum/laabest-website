...
$result=mysqli_query($db,"UPDATE tems SET title='$title',image='$image_file' WHERE id=$id"); 
	}
	else 
	{
	$result=mysqli_query($db,"UPDATE tems SET title='$title' WHERE id=$id"); 	
	} 
if($result)
{
 header("location:job.php?action=saved");
}
else 
{
...
<form action="" method="POST" enctype="multipart/form-data">
	...
	<button name="update_submit" class="btn-primary">PostII </button>
	<br><br><hr>
    <label> </label>
	<input type="text" name="title" value="<?php echo $title;?>" class="form-control">
	<label> </label><br>
	&nbsp; <img src="uploads2/<?php echo $image;?>" height="" width="80%"><br>
	<label></label>
