...
$result=mysqli_query($db,"UPDATE atam SET title='$title',image='$image_file' WHERE id=$id"); 
	}
	else 
	{
	$result=mysqli_query($db,"UPDATE atam SET title='$title' WHERE id=$id"); 	
	} 
if($result)
{
 header("location:showbeam.php?action=saved");
}
else 
{
...
<form action="" method="POST" enctype="multipart/form-data">
	...
	<label> </label><br>
	&nbsp; <video src="uploads3/<?php echo $image;?>" height="" width="80%"><br>
	<label></label>
